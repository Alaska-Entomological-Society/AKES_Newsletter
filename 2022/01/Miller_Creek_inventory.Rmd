...
or$GUID <- paste0("[iNaturalist.org:", or$inat, "](https://www.inaturalist.org/observations/", or$inat[sl], ")")
...
knitr::kable(sr[,c("phylum", "scientific_name", "waterbody", "GUID")], 
  longtable = TRUE, 
  booktabs = TRUE,
  col.names = c("Phylum", "Identification", "Water Body", "Identifiers"),
  row.names = FALSE,
  caption = "Specimen records. The identifiers are hyperlinked to the complete records on Arctos and iNaturalist.org."
)
```
