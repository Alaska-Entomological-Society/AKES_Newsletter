...
In the metabarcoding dataset a total of 589,486 reads representing 277 ESVs were retained after filtering. After consolidating ESVs that were variants of the same species, 175 unique identifications were retained. The most abundant identifications were *Gammarus lacustris* with 86,576 reads, *Enallagma* sp. BOLD:AAA2218 with 73,898 reads, and *Sphaerium nitidum* with 41,880. Read abundances of these and all other identifications are represented by circle sizes in Figure \@ref(fig:chordplot).
