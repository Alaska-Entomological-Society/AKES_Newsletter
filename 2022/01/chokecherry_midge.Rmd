...
```{r midgetree, fig.cap="An ornamental *Prunus virginiana* with a substantial amount of galled fruit caused by the chokecherry midge."}
...
```{r midgemap, fig.cap="Map of locations where the chokecherry midge was recorded in Anchorage in 2021. Observed locations are indicated by red circles."}
