...
We processed data in R, versions 4.0.1 and 4.1.2 \citep{RCoreTeam2021} using the R packages ape, version 5.6-1 \citep{ParadisSchliep2019}; Biostrings, version 2.62.0 \citep{Pagesetal2021} bold, version 1.2.0 \citep{Chamberlain2021}; ggtree, version 3.2.1 \citep{Yuetal2017, Yuetal2018, Yu2020}; msa, version 1.26.0 \citep{Bodenhoferetal2015}; odseq, version 1.22.0 \citep{Jimenez2021}; reshape2, version 1.4.4 \citep{Wickham2007}; and treeio, version 1.18.1 \citep{Wangetal2020}.
