...
We processed data in R, versions 4.0.1 and 4.1.2 \citep{RCoreTeam2021} using the R packages Biostrings, version 2.62.0 \citep{Pagesetal2021} bold, version 1.2.0 \citep{Chamberlain2021}; msa, version 1.26.0 \citep{Bodenhoferetal2015}; and reshape2, version 1.4.4 \citep{Wickham2007}.
