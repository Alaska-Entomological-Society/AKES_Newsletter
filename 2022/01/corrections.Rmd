...
Using presence-only data for *N. hybridus* a niche model for this species was estimated which shows Whitehorse to have habitat unsuitable for this species (Fig. 1). Thus, making it far more likely that the specimens in question were actually *N. investigator.*
