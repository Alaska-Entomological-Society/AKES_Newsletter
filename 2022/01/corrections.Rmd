...
```{r Nguttulamap, fig.cap="Map of records for *Nicrophorus guttula* Motschulsky showing observations (red dots) and habitat suitability probability (colors, see key) based on presence-only niche modeling using the bioclim algorithm in the dismo package in R."}
