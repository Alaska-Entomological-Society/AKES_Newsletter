...
(ref:socialwaspscovercap) Cover of *The Social Wasps of North America*.

(ref:socialwaspscoveralt) A book cover with illustrations of wasps on it.

```{r waspbook, fig.alt="(ref:socialwaspscoveralt)", fig.cap="(ref:socialwaspscovercap)"}
