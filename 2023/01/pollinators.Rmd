...
We detected no bees in the sample from 2011 and 12 species of bees in 2022 (Table \@ref(tab:sumbee)). All of these bee species are widespread in Alaska based on occurrence records available through the Global Biodiversity Information Facility (GBIF, <https://www.gbif.org/>), but are not aware of other records of *Andrena milwaukeensis* or *Halictus rubicundus* from the Kenai Peninsula.
