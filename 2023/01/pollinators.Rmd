...
In 2011, the most abundant species in terms of read abundances was 16,848 reads of *Ctenicera angusticollis* (Figure \@ref(fig:ab2011)).

```{r ab2011, out.width='75%', fig.alt="Bar plot showing read DNA abundances of the 16 most abundant taxa, ranging from 16,848 for Ctenicera angusticollis to 478 for BIN BOLD:ACI3668.", fig.cap="Top 16 most abundant taxa in terms of DNA read abundances from the single 2011 pollinator sample."}
knitr::include_graphics('img/pollinators_top_read_abundances_2011.png')
```


```{r ab2022, out.width='75%', fig.alt="Bar plot showing read DNA abundances of the 16 most abundant taxa, ranging from 169,420 for Speyeria mormonia to 26,962 for Apocephalus borealis.", fig.cap="Top 16 most abundant taxa in terms of DNA read abundances from the 2022 pollinator samples."}
