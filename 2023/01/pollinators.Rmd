...
The single legacy sample from 2011 yielded 71 species and 18 BINs (Table \@ref(tab:sum2011)). 
...
The 17 samples collected in 2022 yielded 206 species and 85 BINs (Table \@ref(tab:sum2022)).
...
In the single sample from 2011, the most abundant species in terms of read abundances was 16,848 reads of *Ctenicera angusticollis* (Figure \@ref(fig:ab2011)). Other abundant identifications were flies in the families Muscidae, Anthomyiidae, and Fanniidae.
...
In 2022, the highest read abundance was for *Speyeria mormonia* (Boisduval, 1869) (Lepidoptera: Nymphalidae), which we detected in three samples (Figure \@ref(fig:ab2022)). Reads of *Helina* species (Diptera: Muscidae), *Rhadiurgus variabilis* (Zetterstedt, 1838) (Diptera: Asilidae), and *Xylota subfasciata* Loew, 1866 were also abundant.
...
The most frequently observed identifications were four *Helina* species that were detected in 5&ndash;10 out of the 17 samples. The fungus *Cladosporium bruhnei* Linder (Capnodiales: Cladosporiaceae) was detected in counts 6 samples. The bee parasite *Apocephalus borealis* Brues, 1924 (Diptera: Phoridae) was detected in four samples. 
...
The fungus *Cladosporium bruhnei* is common from environmental samples worldwide, collected from living and dead plants, air, water, and humans [@Schubertetal2007; @Benschetal2012]. We found no literature records of *Cladosporium bruhnei* taken from insects, but *Cladosporium* species can function as symbionts or pathogens of insects [@Liuetal2022].
...
Complementing morphological identifications by metabarcoding enabled us to efficiently identify many more non-bee species than we have been able to process and identify in a timely way and it also provided detections of some bee parasites. In 2023 we plan to participate in the Alaska Bee Atlas again using similar methods, submitting most bee specimens to the Alaska Center for Conservation Science and processing samples of mostly non-bees by metabarcoding. We believe that using multiple methods will be an expedient way to improve our understanding of insect pollinators in Alaska.
