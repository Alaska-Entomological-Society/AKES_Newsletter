...
knitr::kable(orchidvpoltab, 
  ...
  caption = "Summaries for orchid genera and and numbers of insect species known to pollinate orchid species in an orchid pollinator network in Southeast Alaska. *n*<sub>spp</sub>: number of orchid species."
) %>%
