...
```{r orchidgeneratable}
gentab <- read.csv("orchid_genera_table.csv", row.names = 1)
gentab <- as.data.frame(t(gentab))
...
knitr::kable(gentab, 
  ...
  booktabs = TRUE,
  escape = FALSE,
  col.names = names(gentab),
  caption = "Numbers of insect species known to pollinate orchid species in an orchid pollinator network in Southeast Alaska."
) 
```
...
knitr::kable(format_table(x = orchidvpoltab, format = out_format), 
  format = out_format,           
  longtable = TRUE, 
  booktabs = TRUE,
  escape = FALSE,
  ...
  caption = "Numbers of insect species known to pollinate orchid species in an orchid pollinator network in Southeast Alaska."
      ...
      column_spec(5, width = ".9in") %>%
      column_spec(6, width = ".9in") %>%
      column_spec(7, width = ".9in") %>%
      column_spec(8, width = ".9in") %>%
      column_spec(9, width = ".9in") %>%
      column_spec(10, width = ".9in")
```
