...
For the morphologically identified specimens, we used the following references: \cite{Borroretal1989}, \cite{Collet2008}, \cite{Durfee2005}, \cite{Hatch1953}, \cite{Kenner2009}, \cite{MerrittCummins1996}, \cite{Merrittetal2008}, \cite{Reid1987}, \cite{Roughley2000}, \cite{Wallis1933}, and \cite{White1983}.
